...
img3 = cv2.drawMatches(img1_rgb, kp1, img2_rgb, kp2, matches[:10], None, flags = 2)
plt.imshow(img3), plt.title('10 first matches (' + str(len(matches)) + ' found, ' + str(len(kp1)) + ' generated)'), plt.show()
